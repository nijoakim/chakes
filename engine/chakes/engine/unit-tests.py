...
class TestPieces(ut.TestCase):
    def test_rook(self):
        ...
        self.assertEqual(
            set(pos_list_to_str(game_state.piece_at('B3').valid_moves())),
    ...
    def test_pawn(self):
        ...
        self.assertEqual(
            set(pos_list_to_str(game_state.piece_at('B6').valid_moves())),
            {'A7', 'C7'},
        )
    ...
    def test_knight(self):
        ...
        self.assertEqual(
            set(pos_list_to_str(game_state.piece_at('C3').valid_moves())),
            {'B1', 'A4', 'B5', 'D5', 'E4'},
        )
    ...
    def test_bishop(self):
        ...
        self.assertEqual(
            set(pos_list_to_str(game_state.piece_at('E3').valid_moves())),
    ...
    def test_queen(self):
        ...
        self.assertEqual(
            set(pos_list_to_str(game_state.piece_at('F3').valid_moves())),
    ...
    def test_king(self):
        ...
        self.assertEqual(
            set(pos_list_to_str(game_state.piece_at('E2').valid_moves())),
            {'E1', 'D3', 'E3', 'F3'},
        )
    ...
    def test_castling(self):
        ...
        self.assertEqual(
            set(pos_list_to_str(game_state.piece_at('E1').valid_moves())),
            {'C1', 'D1', 'F1', 'G1'}
